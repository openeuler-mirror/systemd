...
Patch0067:      0067-backport-varlink-make-userdata-pointer-inheritance-from-varli.patch
Patch0068:      0068-backport-journal-refresh-cached-credentials-of-stdout-streams.patch
Patch0069:      0069-backport-journald-rework-end-of-line-marker-handling-to-use-a.patch
...
Patch0082:      backport-core-fix-free-undefined-pointer-when-strdup-failed-i.patch
Patch0083:      backport-test-adapt-to-the-new-capsh-format.patch
Patch0084:      backport-0001-CVE-2021-3997-rm-rf-add-new-flag-REMOVE_CHMOD.patch
Patch0085:      backport-0002-CVE-2021-3997-btrfs-util-add-helper-that-abstracts-might-be-btrfs-.patch
Patch0086:      backport-0003-CVE-2021-3997-rm-rf-fstatat-might-fail-if-containing-dir-has-limit.patch
Patch0087:      backport-0004-CVE-2021-3997-rm-rf-refactor-rm_rf_children-split-out-body-of-dire.patch
Patch0088:      backport-0005-CVE-2021-3997-rm-rf-optionally-fsync-after-removing-directory-tree.patch
Patch0089:      backport-0006-CVE-2021-3997-tmpfiles-st-may-have-been-used-uninitialized.patch
Patch0090:      backport-0007-CVE-2021-3997-shared-rm_rf-refactor-rm_rf_children_inner-to-shorte.patch
Patch0091:      backport-0008-CVE-2021-3997-shared-rm_rf-refactor-rm_rf-to-shorten-code-a-bit.patch
Patch0092:      backport-0009-CVE-2021-3997-shared-rm-rf-loop-over-nested-directories-instead-of.patch
Patch0093:      backport-0001-CVE-2020-13776-user-util-Allow-names-starting-with-a-digit.patch
Patch0094:      backport-0002-CVE-2020-13776-user-util-switch-order-of-checks-in-valid_user_group.patch
Patch0095:      backport-0003-CVE-2020-13776-user-util-rework-how-we-validate-user-names.patch
Patch0096:      backport-0004-CVE-2020-13776-docs-add-a-longer-document-explaining-our-rules-on-u.patch
Patch0097:      backport-0005-CVE-2020-13776-docs-hook-up-the-new-USER_NAMES-document-everywhere.patch
Patch0098:      backport-0006-CVE-2020-13776-catalog-add-entry-for-SD_MESSAGE_UNSAFE_USER_NAME.patch
Patch0099:      backport-0007-CVE-2020-13776-basic-user-util-always-use-base-10-for-user-group-nu.patch
Patch0100:      backport-0008-CVE-2020-13776-parse-util-sometimes-it-is-useful-to-check-if-a-stri.patch
Patch0101:      backport-0009-CVE-2020-13776-basic-parse-util-add-safe_atoux64.patch
Patch0102:      backport-0010-CVE-2020-13776-parse-util-allow-tweaking-how-to-parse-integers.patch
Patch0103:      backport-0011-CVE-2020-13776-parse-util-allow-0-as-alternative-to-0-and-0.patch
Patch0104:      backport-0012-CVE-2020-13776-parse-util-make-return-parameter-optional-in-safe_at.patch
...
Patch0122:      backport-Use-correct-poll.h-include.patch
Patch0123:      backport-core-do-not-serialize-mounts-and-automounts-for-swit.patch
Patch0124:      backport-journal-add-some-careful-overflow-checking.patch
Patch0125:      backport-network-fix-an-infinite-loop.patch
Patch0126:      backport-sd-device-use-right-type-for-usec_initialized.patch
Patch0127:      backport-fix-CVE-2022-3821.patch
Patch0128:      backport-cap-list-parse-numerical-capabilities.patch
Patch0129:      backport-test-use-cap_last_cap-for-max-supported.patch
Patch0130:      backport-CVE-2023-26604-man-share-description-of-SYSTEMD_COLORS.patch
Patch0131:      backport-CVE-2023-26604-man-document-all-pager-variables-for-systemctl.patch
Patch0132:      backport-CVE-2023-26604-pager-set-LESSSECURE-whenver-we-invoke-a-pager.patch
Patch0133:      backport-CVE-2023-26604-test-login-always-test-sd_pid_get_owner_uid.patch
Patch0134:      backport-CVE-2023-26604-pager-make-pager-secure-when-under-euid-is-changed.patch
Patch0135:      backport-CVE-2023-26604-test-ignore-ENOMEDIUM-error-from-sd_pid_get_cgroup.patch
Patch0136:      backport-dns-domain-make-each-label-nul-terminated.patch
Patch0137:      backport-resolve-fix-heap-buffer-overflow-reported-by-ASAN-wi.patch
Patch0138:      backport-growfs-don-t-actually-resize-on-dry-run.patch
Patch0139:      backport-stat-util-replace-is_dir-is_dir_fd-by-single-is_dir_.patch
Patch0140:      backport-tmpfiles-check-the-directory-we-were-supposed-to-cre.patch
Patch0141:      backport-coredump-Connect-stdout-stderr-to-dev-null-before-do.patch
Patch0142:      backport-cgroups-agent-connect-stdin-stdout-stderr-to-dev-nul.patch
Patch0143:      backport-resolve-mdns_packet_extract_matching_rrs-may-return-.patch
Patch0144:      backport-dhcp-fix-potential-buffer-overflow.patch
Patch0145:      backport-log-don-t-attempt-to-duplicate-closed-fd.patch
...
Requires:       %{name}-timesyncd = %{version}-%{release}
Requires:       %{name}-pam = %{version}-%{release}
Requires:       %{name}-resolved = %{version}-%{release}
...
Requires:       %{name}%{?_isa} = %{version}-%{release}
Requires:       %{name}-nspawn = %{version}-%{release}
Obsoletes:      %{name} < 229-5
License:        LGPLv2+
...
* Tue Mar 14 2023 huyubiao <huyubiao@huawei.com> - 243-59
- fix CVE-2023-26604

* Mon Nov 7 2022 yangmingtai <yangmingtai@huawei.com> - 243-58
- fix CVE-2022-3821 and backport patch to fix ci failed

* Tue Oct 18 2022 yangmingtai <yangmingtai@huawei.com> - 243-57
...
- ID:NA
- SUG:NA
- DESC:adapt to the new capsh format for test

* Thu Sep 16 2021 ExtinctFire <shenyining_00@126.com> - 243-47
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:core: fix free undefined pointer when strdup failed in the first loop
...
* Mon Aug 16 2021 yangmingtai <yangmingtai@huawei.com> - 243-43
- Type:CVE
- ID:CVE-2020-13529
- SUG:NA
- DESC:fix CVE-2020-13529

* Tue Aug 10 2021 yangmingtai <yangmingtai@huawei.com> - 243-42
- Type:bugfix
- ID:NA
- SUG:NA
...
* Tue Jul 27 2021 extinctfire <shenyining_00@126.com> - 243-38
- Type:bugfix
- ID:NA
- SUG:NA
...
* Fri May 21 2021 fangxiuning <fangxiuning@huawei.com> - 243-33
- Type:bugfix
- ID:NA
- SUG:NA
